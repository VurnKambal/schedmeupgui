...
import 'sjn_page_model.dart';
export 'sjn_page_model.dart';

class SjnPageWidget extends StatefulWidget {
  const SjnPageWidget({Key? key}) : super(key: key);

  @override
  _SjnPageWidgetState createState() => _SjnPageWidgetState();
}

class _SjnPageWidgetState extends State<SjnPageWidget> {
  late SjnPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SjnPageModel());
